  ...
  return isLoggedIn ? (
      ...
      >
        ...
        <div className="w-full bg-transparent flex flex-col justify-center items-center">
            <h1 className="font-roboto tracking-wide text-2xl font-semibold my-4">We'll send you a mail to your registered email address</h1>

            <p className="font-mono text-lg font-semibold tracking-wider text-blue-500">{(data.email).slice(0,5)}**********{(data.email).slice(data.email.length-7, data.email.length)}</p>
        </div>
