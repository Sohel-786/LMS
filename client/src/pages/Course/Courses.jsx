  ...
  return (
    <HomeLayout>
      <section className="min-h-[90vh] flex flex-col justify-center items-center m-auto py-6 px-7 mb-7">
        <div className="flex flex-col justify-center items-center gap-7 my-10 bg-[#fcf4f5] w-[90%] rounded-lg py-14">
          <h1 className="text-5xl font-bold">Our Courses</h1>
          <p className="text-xl font-roboto font-semibold text-stone-500">
